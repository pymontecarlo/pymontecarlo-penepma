...
def test_referenceline_eq(referenceline):
    ...
    assert referenceline != ReferenceLine(pyxray.xray_line(14, 'Ka1'), photon_detector, 0.05)
    assert referenceline != ReferenceLine(xrayline, PhotonDetector('det2', 0.5, 0.6), 0.05)
