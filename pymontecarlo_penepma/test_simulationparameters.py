...
def test_simulationparameters_eq(simulationparameters):
    assert simulationparameters == SimulationParameters(1e3, 2e3, 3e3, 0.1, 0.2, 4e3, 5e3)

    assert simulationparameters != SimulationParameters(99, 2e3, 3e3, 0.1, 0.2, 4e3, 5e3)
    assert simulationparameters != SimulationParameters(1e3, 99, 3e3, 0.1, 0.2, 4e3, 5e3)
    assert simulationparameters != SimulationParameters(1e3, 2e3, 99, 0.1, 0.2, 4e3, 5e3)
    assert simulationparameters != SimulationParameters(1e3, 2e3, 3e3, 0.09, 0.2, 4e3, 5e3)
    assert simulationparameters != SimulationParameters(1e3, 2e3, 3e3, 0.1, 0.09, 4e3, 5e3)
    assert simulationparameters != SimulationParameters(1e3, 2e3, 3e3, 0.1, 0.2, 99, 5e3)
    assert simulationparameters != SimulationParameters(1e3, 2e3, 3e3, 0.1, 0.2, 4e3, 99)
...
def test_lazysimulationparameters_eq(lazysimulationparameters):
    ...
    assert lazysimulationparameters != LazySimulationParameters(pyxray.xray_line(13, 'Ka1'), c1=0.1, c2=0.15)
